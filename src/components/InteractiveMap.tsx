      ...
      >
        ...
        >
          ...
          {backgroundImage && !imageError ? (
            ...
            !isImageLoading && (
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-brand-green/5 text-brand-green/40 p-8 text-center">
                <ImageIcon size={48} className="mb-4 opacity-20" />
                <p className="font-serif italic text-lg mb-2">Erro ao carregar o mapa</p>
                <p className="text-xs font-mono uppercase tracking-widest max-w-xs">
                  A imagem de fundo pode ser muito grande ou o link expirou. Tente reenviar a imagem no painel administrativo.
                </p>
              </div>
            )
          )}
